...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataset_mode', type=str, default='unaligned_seg', help='chooses how datasets are loaded.')
        # Use insta_gan as a default model
        parser.add_argument('--model', type=str, default='insta_gan', help='chooses which model to use.')
